...
var app = (function () {
    ...
    /* src/Spring.svelte generated by Svelte v3.59.2 */
    ...
    // (63:2) {#each $cards as card, i (card.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "card svelte-2o9o4v");
    			...
    			add_location(div, file$1, 64, 3, 1005);
    			this.first = div;
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:2) {#each $cards as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$1, 61, 1, 884);
    			attr_dev(div1, "class", "page svelte-2o9o4v");
    			add_location(div1, file$1, 60, 0, 864);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<Spring> was created with unknown prop '${key}'`);
    	});
    ...
    // (61:0) {#each boxes as box (box)}
    function create_each_block_3(key_1, ctx) {
    	let div;
    	let t_value = /*box*/ ctx[15] + "";
    	let t;
    	let div_transition;
    	let rect;
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "svelte-uyc3al");
    			add_location(div, file, 62, 1, 1422);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(
    						...
    						"click",
    						function () {
    							if (is_function(/*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 0))) /*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 0).apply(this, arguments);
    						},
    						false,
    						false,
    						false,
    					...
    					listen_dev(div, "introstart", /*introstart_handler*/ ctx[10], false, false, false, false),
    					listen_dev(div, "introend", /*introend_handler*/ ctx[11], false, false, false, false),
    					listen_dev(div, "outrostart", /*outrostart_handler*/ ctx[12], false, false, false, false),
    					listen_dev(div, "outroend", /*outroend_handler*/ ctx[13], false, false, false, false)
    				];
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes*/ 4) && t_value !== (t_value = /*box*/ ctx[15] + "")) set_data_dev(t, t_value);
    		},
    		r: function measure() {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!current) return;
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { x: 200, y: 0 }, true);
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, fly, { x: 200, y: 0 }, false);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(61:0) {#each boxes as box (box)}",
    		ctx
    	});
    ...
    function create_each_block_2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "d1 svelte-uyc3al");
    			add_location(div, file, 78, 1, 1901);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 1))) /*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 1).apply(this, arguments);
    					},
    					false,
    					false,
    					false,
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes1*/ 8) && t_value !== (t_value = /*box*/ ctx[15] + "")) set_data_dev(t, t_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			...
    			add_render_callback(() => {
    				if (!current) return;
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { x: 200, y: 0 }, true);
    				div_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { x: 200, y: 0 }, false);
    			div_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(77:0) {#each boxes1 as box (box)}",
    		ctx
    	});
    ...
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			div = element("div");
    			t = text(t_value);
    			attr_dev(div, "class", "d2 svelte-uyc3al");
    			add_location(div, file, 90, 1, 2117);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 2))) /*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 2).apply(this, arguments);
    					},
    					false,
    					false,
    					false,
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes2*/ 16) && t_value !== (t_value = /*box*/ ctx[15] + "")) set_data_dev(t, t_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			...
    			add_render_callback(() => {
    				if (!current) return;
    				if (!div_transition) div_transition = create_bidirectional_transition(div, slide, { x: 200, y: 0 }, true);
    				div_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, slide, { x: 200, y: 0 }, false);
    			div_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(89:0) {#each boxes2 as box (box)}",
    		ctx
    	});
    ...
    // (101:0) {#each boxes3 as box (box)}
    function create_each_block(key_1, ctx) {
    	let div;
    	let t0_value = /*box*/ ctx[15] + "";
    	let t0;
    	let t1;
    	let div_transition;
    	let current;
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "d3 svelte-uyc3al");
    			add_location(div, file, 102, 1, 2334);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 3))) /*discard*/ ctx[7].bind(this, /*box*/ ctx[15], 3).apply(this, arguments);
    					},
    					false,
    					false,
    					false,
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*boxes3*/ 32) && t0_value !== (t0_value = /*box*/ ctx[15] + "")) set_data_dev(t0, t0_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			...
    			add_render_callback(() => {
    				if (!current) return;
    				if (!div_transition) div_transition = create_bidirectional_transition(div, scale, { x: 200, y: 0 }, true);
    				div_transition.run(1);
    			});
    		...
    		o: function outro(local) {
    			if (!div_transition) div_transition = create_bidirectional_transition(div, scale, { x: 200, y: 0 }, false);
    			div_transition.run(0);
    			current = false;
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(101:0) {#each boxes3 as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const get_key_1 = ctx => /*box*/ ctx[15];
    	...
    	const get_key_2 = ctx => /*box*/ ctx[15];
    	...
    	validate_each_argument(each_value);
    	const get_key_3 = ctx => /*box*/ ctx[15];
    	...
    	const block = {
    		c: function create() {
    			...
    			each3_anchor = empty();
    			add_location(button0, file, 44, 0, 1043);
    			attr_dev(hr0, "class", "svelte-uyc3al");
    			add_location(hr0, file, 55, 0, 1208);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 57, 0, 1216);
    			add_location(button1, file, 58, 0, 1259);
    			add_location(i, file, 58, 39, 1298);
    			attr_dev(hr1, "class", "svelte-uyc3al");
    			add_location(hr1, file, 74, 0, 1806);
    			attr_dev(hr2, "class", "svelte-uyc3al");
    			add_location(hr2, file, 86, 0, 2022);
    			attr_dev(hr3, "class", "svelte-uyc3al");
    			add_location(hr3, file, 98, 0, 2239);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*discard, boxes, console*/ 132) {
    				each_value_3 = /*boxes*/ ctx[2];
    				validate_each_argument(each_value_3);
    				group_outros();
    				for (let i = 0; i < each_blocks_3.length; i += 1) each_blocks_3[i].r();
    				validate_each_keys(ctx, each_value_3, get_each_context_3, get_key);
    				each_blocks_3 = update_keyed_each(each_blocks_3, dirty, get_key, 1, ctx, each_value_3, each0_lookup, t9.parentNode, fix_and_outro_and_destroy_block, create_each_block_3, t9, get_each_context_3);
    			...
    			if (dirty & /*discard, boxes3*/ 160) {
    				...
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key_3);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key_3, 1, ctx, each_value, each3_lookup, each3_anchor.parentNode, outro_and_destroy_block, create_each_block, each3_anchor, get_each_context);
    				check_outros();
    			}
    		},
    		i: function intro(local) {
