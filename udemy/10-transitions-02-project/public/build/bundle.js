    ...
    function create_each_block_3(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 61, 1, 1373);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_each_block_2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 76, 1, 1831);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:0) {#each boxes1 as box (box)}",
    		ctx
    	});
    ...
    function create_each_block_1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 88, 1, 2047);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(87:0) {#each boxes2 as box (box)}",
    		ctx
    	});
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file, 100, 1, 2264);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(99:0) {#each boxes3 as box (box)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each3_anchor = empty();
    			add_location(button0, file, 43, 0, 994);
    			attr_dev(hr0, "class", "svelte-uyc3al");
    			add_location(hr0, file, 54, 0, 1159);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 56, 0, 1167);
    			add_location(button1, file, 57, 0, 1210);
    			add_location(i, file, 57, 39, 1249);
    			attr_dev(hr1, "class", "svelte-uyc3al");
    			add_location(hr1, file, 72, 0, 1736);
    			attr_dev(hr2, "class", "svelte-uyc3al");
    			add_location(hr2, file, 84, 0, 1952);
    			attr_dev(hr3, "class", "svelte-uyc3al");
    			add_location(hr3, file, 96, 0, 2169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
