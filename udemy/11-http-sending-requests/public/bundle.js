...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	let ul;
    	let each_value = /*$hobbyStore*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file, 68, 1, 1358);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$hobbyStore*/ 4) {
    				each_value = /*$hobbyStore*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			attr_dev(li, "class", "svelte-3ig9g4");
    			add_location(li, file, 70, 3, 1397);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(70:2) {#each $hobbyStore as hobby}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label, file, 61, 0, 1177);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "id", "hobby");
    			add_location(input, file, 62, 0, 1210);
    			add_location(button, file, 63, 0, 1266);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $hobbyStore;
    	validate_store(customStore, 'hobbyStore');
    	component_subscribe($$self, customStore, $$value => $$invalidate(2, $hobbyStore = $$value));
    	...
    	fetch("https://svelte-001-411ee-default-rtdb.europe-west1.firebasedatabase.app/hobbies.json").then(res => {
    		...
    		customStore.setHobbies(Object.values(data));
    	...
    	return [hobbyInput, isLoading, $hobbyStore, addHobby, input_binding];
    }
